    ...
    <main className="min-h-screen">
      ...
      <section className="px-6 sm:px-12 py-4 pb-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          <AudienceCard icon="film" title="Bangladeshi drama models" desc="Verified profiles of familiar faces from television and web dramas, here for real conversations, not fan mail." />
          <AudienceCard icon="bolt" title="Instagram & TikTok influencers" desc="Content creators and social personalities with verified profiles, looking for something genuine off-camera." />
          <AudienceCard icon="heart" title="Divorced & single parents welcome" desc="A judgment-free space for divorced members and single mothers ready to date again — no assumptions, no awkward questions." />
          <AudienceCard icon="shield" title="Verified professionals" desc="Occupation and, optionally, income verification for members who want to signal they are serious and established." />
          <AudienceCard icon="check" title="College/University students" desc="Valid student ID verification opens a safe, age-appropriate space to meet people on and off campus." />
          <AudienceCard icon="star" title="News presenters (women)" desc="Verified profiles of familiar broadcast faces, here for genuine conversations away from the camera." />
        </div>
      </section>
